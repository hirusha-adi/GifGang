...
os.system("sudo apt install mongodb -y")
...
os.system("sudo apt update && sudo apt upgrade -y")
os.system("sudo apt install python3 python3-pip git nano -y")
...
os.system("python3 gifgang.net &")
os.system("bg")
os.system("disown -h")

sleep(5)

os.system("python3 discord-bot.py &")
os.system("bg")
os.system("disown -h")
